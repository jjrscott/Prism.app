...
//! Project version number for PrismCommon.
FOUNDATION_EXPORT double PrismCommonVersionNumber;

//! Project version string for PrismCommon.
FOUNDATION_EXPORT const unsigned char PrismCommonVersionString[];
